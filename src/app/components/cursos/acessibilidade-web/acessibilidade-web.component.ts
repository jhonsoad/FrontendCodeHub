...
@Component({
  ...
  imports: [
    FooterA11yComponent,
    HeaderA11yComponent,
    ContactA11yComponent,
    HighlightA11yComponent,
    DifferentialA11yComponent,
    AboutA11yComponent,
    PlansA11yComponent,
    BlogA11yComponent,
    HighlightsA11yComponent,
    InstitutionalA11yComponent,
  ],
...
export class AcessibilidadeWebComponent implements OnInit {
  ...
  adicionaLinksTags(): void {
    this.utilsService.adicionaLinkTag(
      'stylesheet',
      'https://fonts.googleapis.com/css?family=Montserrat:300,400,700|Open+Sans:300,400,700',
    );
  }
}
